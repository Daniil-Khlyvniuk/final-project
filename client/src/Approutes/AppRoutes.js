...
import PaymentAndDelivery
	from '../staticPages/PaymentAndDelivery/PaymentAndDelivery'
...
const AppRoutes = () => {
	...
	return (
		<Switch>
			...
			<ProtectedRoute
				exact path="/productslist" isLoggedIn={ isLoggedIn }>
				<ProductsList/>
			</ProtectedRoute>
			<ProtectedRoute
				exact path="/productdetails" isLoggedIn={ isLoggedIn }>
				<ProductDetails/>
			</ProtectedRoute>
			...
			<Route exact path="/paymentanddelivery"><PaymentAndDelivery/>
			</Route>
